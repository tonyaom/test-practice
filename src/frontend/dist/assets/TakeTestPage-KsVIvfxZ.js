import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, Q as QuestionType, ao as Checkbox, L as Label, I as Input, G as useParams, ap as useNavigate, H as useAuth, J as useBackend, M as useDataSyncContext, aq as useSearch, ah as useQuery, ar as loadSession, as as saveSession, at as loadStoredAnswers, au as saveStoredAnswers, N as useMutation, T as Skeleton, _ as Card, $ as CardHeader, av as CardContent, aw as LayoutDashboard, O as Link, B as Button, ax as getTestCache, U as ArrowLeft, aj as CircleCheck, W as Badge, w as Dialog, x as DialogContent, y as DialogHeader, z as DialogTitle, ay as DialogDescription, E as DialogFooter, a3 as ue, az as saveCompletedSessionSnapshot, aA as removeSession, V as Layers } from "./index-CVHVWwCD.js";
import { R as RichTextDisplay } from "./RichTextDisplay-BX4daxAP.js";
import { G as GripVertical, A as AlignLeft, S as SquareCheckBig } from "./square-check-big-nEO12U4B.js";
...
function DragDropQuestion({
  ...
  const touchDragIdxRef = reactExports.useRef(null);
  const touchStartYRef = reactExports.useRef(0);
  const [showHint, setShowHint] = reactExports.useState(() => {
    try {
  ...
  function handleTouchStart(e, listIdx) {
  ...
  function handleTouchMove(e) {
    ...
    const items2 = document.querySelectorAll("[data-drag-item]");
    let targetIdx = null;
    for (let i = 0; i < items2.length; i++) {
      const rect = items2[i].getBoundingClientRect();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", "data-ocid": "drag_drop.list", children: [
    ...
    showHint && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2 p-2.5 rounded-lg bg-muted/50 border border-border text-xs text-muted-foreground mb-2 sm:hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Press and hold to drag items on mobile" }),
    ...
    displayOrder.map((itemIdx, listIdx) => {
      const isDragging = draggingIdx === listIdx || touchDragIdxRef.current === listIdx;
      const isOver = overIdx === listIdx && draggingIdx !== listIdx && touchDragIdxRef.current !== listIdx;
...
function TakeTestPage() {
  ...
  const { getQuestions: getCachedQuestions, getTest: getCachedTest } = useDataSyncContext();
  ...
  const audioElementRef = reactExports.useRef(null);
  ...
  const submitMutation = useMutation({
    ...
    onSuccess: (results) => {
      ...
      const delay = isPerfect ? 2e3 : 1500;
    ...
    function handleKeyDown(e) {
      ...
      if (e.key === " " || e.key === "Enter") {
        ...
        if (currentQuestion && !submitMutation.isPending) {
          const qId2 = String(currentQuestion.id);
          const isChecked2 = checkedIds.has(qId2);
          const answer2 = getAnswer(currentQuestion);
          const hasAnswer = answer2.selectedOptions.length > 0 || answer2.textAnswer.trim().length > 0;
          if (hasAnswer || isChecked2) handleCheckOrNext();
        }
  ...
  const [celebrationVisible, setCelebrationVisible] = reactExports.useState(false);
  const [celebrationPerfect, setCelebrationPerfect] = reactExports.useState(false);
  const celebrationTimerRef = reactExports.useRef(
    null
  );
  function showCelebration(perfect) {
    setCelebrationPerfect(perfect);
    setCelebrationVisible(true);
  }
  const [keyboardHintSeen, setKeyboardHintSeen] = reactExports.useState(() => {
    try {
  ...
  const [keyboardHintVisible, setKeyboardHintVisible] = reactExports.useState(false);
  reactExports.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      "data-ocid": "test.page",
      children: [
        celebrationVisible && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "celebration-confetti", "aria-hidden": "true", children: Array.from({ length: 30 }, (_, i) => `confetti-${i}`).map(
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center animate-slide-in-up", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-6xl mb-4", children: celebrationPerfect ? "🏆" : "✅" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl font-bold text-foreground mb-2", children: celebrationPerfect ? "🏆 Perfect Score!" : "Test Complete!" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: celebrationPerfect ? "Outstanding! Every answer was correct!" : "Great work — reviewing your results…" })
              ] })
            ]
          }
        ),
        keyboardHintVisible && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3 mb-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground", children: "Keyboard Shortcuts" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5 text-xs text-muted-foreground", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("kbd", { className: "px-1.5 py-0.5 bg-muted rounded text-xs font-mono", children: "Space" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Submit / Continue" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("kbd", { className: "px-1.5 py-0.5 bg-muted rounded text-xs font-mono", children: "B" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Toggle bookmark" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("kbd", { className: "px-1.5 py-0.5 bg-muted rounded text-xs font-mono", children: "R" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Replay audio" })
                ] })
              ] })
            ]
          }
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "button",
                    {
                      ...
                      onClick: () => handleFontSizeChange(Math.max(FONT_SIZE_MIN, fontSize - 1)),
                      ...
                      children: [
                        "A",
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "8px", verticalAlign: "sub" }, children: "-" })
                      ]
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground tabular-nums w-7 text-center select-none", children: fontSize }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "button",
                    {
                      type: "button",
                      ...
                      onClick: () => handleFontSizeChange(Math.min(FONT_SIZE_MAX, fontSize + 1)),
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "8px", verticalAlign: "super" }, children: "+" })
                      ]
                    }
                  )
                ]
          ...
          Card,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "pb-4 border-b border-border", children: [
                ...
                (currentQuestion == null ? void 0 : currentQuestion.audioUrl) && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    className: "mt-3",
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      ...
                      `${String(currentQuestion.id)}-${sessionIdRef.current}`
                    )
                  },
                  `${String(currentQuestion.id)}-${sessionIdRef.current}`
                )
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-5", style: { fontSize: `${fontSize}px` }, children: [
                ...
                isChecked && !correct && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 space-y-2", "data-ocid": "test.answer_banners", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(CircleX, { className: "w-4 h-4 shrink-0 text-destructive mt-0.5" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-destructive uppercase tracking-wide block mb-0.5", children: "Your Answer" }),
                          (q.questionType === QuestionType.mcSingle || q.questionType === QuestionType.mcMulti) && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1", children: answer.selectedOptions.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-destructive/70 italic", children: "No answer selected" }) : answer.selectedOptions.map((displayIdx) => {
                            const origIdx = optMap ? optMap[displayIdx] : displayIdx;
                            const opt = q.options[origIdx];
                            return opt ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                              RichTextDisplay,
                              {
                                html: opt,
                          ...
                          q.questionType === QuestionType.dragOrder && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1", children: answer.dragOrder.map((idx, pos) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            "span",
                            {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-accent uppercase tracking-wide block mb-0.5", children: "Correct Answer" }),
                ...
                isChecked && correct && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-accent", children: "Correct! ✓" })
                    ]
                  }
                ),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              disabled: submitMutation.isPending || !hasAnswerEntered && !isChecked || isChecked && correct === true,
              className: "gap-2",
              "data-ocid": isChecked ? isLast ? "test.submit_button" : "test.next_button" : "test.check_button",
              children: submitMutation.isPending ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { "data-ocid": "test.loading_state", children: "Submitting…" }) : isChecked ? correct ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent", children: "Auto-advancing…" }) : isLast ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
