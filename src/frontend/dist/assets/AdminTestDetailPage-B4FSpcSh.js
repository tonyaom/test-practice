...
import { k as katex, R as RichTextDisplay } from "./RichTextDisplay-BX4daxAP.js";
/**
...
function QuestionForm({
  ...
  function handleAudioUrlChange(url) {
    update({ audioUrl: url });
  }
  function clearAudio() {
    update({ audioUrl: "" });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
      ...
      data.audioUrl.trim() && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("audio", { src: data.audioUrl, controls: true, className: "flex-1 h-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("track", { kind: "captions" }) })
          ]
        }
      )
    ] }),
    ...
    showOptions && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: data.options.map((opt, i) => {
...
function AdminTestDetailPage() {
  ...
  const questions = cachedQuestions.map((cq) => ({
    id: BigInt(cq.id),
    ...
    sectionId: cq.sectionId != null ? BigInt(cq.sectionId) : void 0,
    questionUpdatedAt: BigInt(cq.questionUpdatedAt),
    explanation: cq.explanation ?? void 0,
    audioUrl: cq.audioUrl ?? void 0
  }));
  const cachedSections = getCachedSections(testId);
  const sections = cachedSections.map((cs) => ({
    id: BigInt(cs.id),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "nav",
      {
        ...
        children: [
          ...
          selectedSection ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                ...
                children: (test == null ? void 0 : test.name) ?? "Loading…"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground hidden sm:inline", children: "›" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-foreground", children: selectedSection.name })
          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-foreground", children: (test == null ? void 0 : test.name) ?? "Loading…" })
        ]
      }
    ),
    ...
    selectedSection ? (
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "admin.detail.section.drilldown.panel", children: [
        ...
        sectionQuestions.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            sections.length === 0 && getUncategorisedCount() === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
